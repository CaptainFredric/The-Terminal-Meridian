...
export const moduleOrder = ["briefing", "home", "quote", "chart", "news", "screener", "heatmap", "portfolio", "trade", "macro", "options", "calculator", "rules", "ai", "settings"];
...
export const commandCatalog = [
  ...
  { cmd: "IF @WATCHLIST > 5pct THEN Watchlist mover", desc: "Apply rule to all watchlist symbols (alerts each when condition is met)" },
  ...
  { cmd: "SETTINGS", desc: "Open workspace settings panel" },
];
...
const defaultUniverse = [
  ["AAPL", "Apple", "Information Technology", "S&P 500", 198.62, 2860000000000],
  ["MSFT", "Microsoft", "Information Technology", "S&P 500", 381.25, 2940000000000],
  ["NVDA", "NVIDIA", "Information Technology", "S&P 500", 112.47, 2680000000000],
  ["TSLA", "Tesla", "Consumer Discretionary", "S&P 500", 243.18, 780000000000],
  ["AMZN", "Amazon", "Consumer Discretionary", "S&P 500", 198.80, 2110000000000],
  ["GOOGL", "Alphabet", "Communication Services", "S&P 500", 164.38, 2020000000000],
  ["META", "Meta", "Communication Services", "S&P 500", 571.09, 1450000000000],
  ["AMD", "AMD", "Information Technology", "S&P 500", 101.28, 165000000000],
  ["QCOM", "Qualcomm", "Information Technology", "S&P 500", 158.44, 171000000000],
  ["AVGO", "Broadcom", "Information Technology", "S&P 500", 188.62, 890000000000],
  ["PLTR", "Palantir", "Information Technology", "Growth", 118.62, 258000000000],
  ["COIN", "Coinbase", "Financials", "Growth", 208.44, 51000000000],
  ["ABNB", "Airbnb", "Consumer Discretionary", "Growth", 131.18, 84000000000],
  ["UBER", "Uber", "Industrials", "Growth", 76.34, 159000000000],
  ["CRWD", "CrowdStrike", "Information Technology", "Growth", 437.22, 108000000000],
  ["SPY", "SPDR S&P 500", "ETF", "ETF", 527.30, 0],
  ["QQQ", "Invesco QQQ", "ETF", "ETF", 430.12, 0],
  ["IWM", "iShares Russell 2000", "ETF", "ETF", 197.44, 0],
  ["TLT", "iShares 20Y Treasury", "ETF", "ETF", 85.62, 0],
  ["BTC-USD", "Bitcoin", "Cryptocurrency", "Crypto", 84201, 0],
  ["ETH-USD", "Ethereum", "Cryptocurrency", "Crypto", 1622, 0],
];
